...
<!-- SEO Meta Tags -->
  ...
  <link href="https://fonts.googleapis.com/css2?family=Chango&family=Zen+Maru+Gothic:wght@400;700&display=swap" rel="stylesheet" />
...
<script>
  window.onload = function () {
    ...
    const spOnly = document.querySelectorAll(".sp-only");
    ...
    // Show loading animation only for first-time visitors
    if (!hasVisited) {
      ...
      setTimeout(() => {
        ...
        // After logo fades, start curtain animation
        setTimeout(() => {
    ...
    triggers.forEach(trigger => {
      trigger.addEventListener('click', function() {
        ...
        if (type === 'calendar') {
          lightboxImage.src = 'img/calendar.jpg';
          lightboxImage.style.display = 'block';
          lightboxMap.style.display = 'none';
        } else if (type === 'map') {
          const iframe = lightboxMap.querySelector('iframe');
          iframe.src = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d246.86674366108105!2d139.26808914237992!3d35.790599026951654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6019252fb524f031%3A0x96a48bd03a281c5!2sToful%20Bagel%20cafe!5e0!3m2!1sen!2sjp!4v1754301077715!5m2!1sen!2sjp';
          lightboxMap.style.display = 'block';
    ...
    lightboxClose.addEventListener('click', function() {
      ...
      const iframe = lightboxMap.querySelector('iframe');
      iframe.src = ''; // Stop the map from loading
    });
    ...
    // ナビゲーションリンククリック時にメニューを閉じる（SP用）
    document.querySelectorAll('.nav-menu a, .nav-instagram a').forEach(link => {
      link.addEventListener('click', function(e) {
        // Instagramリンクの場合は外部リンクなのでpreventDefaultしない
        if (!this.classList.contains('instagram-icon')) {
          ...
          // Instagramリンクの場合はモバイル時のみメニューを閉じる
          if (window.innerWidth <= 768) {
            closeMenu();
          }
        }
    ...
    // PC用スクロール時ナビゲーション表示/非表示機能
    let lastScrollTop = 0;
    let scrollTimeout;
    const onlineShopIcon = document.querySelector('.online-shop-icon');

    window.addEventListener('scroll', function() {
      const currentScroll = window.pageYOffset || document.documentElement.scrollTop;
      const nav = document.querySelector('nav');
      const spNavIcons = document.querySelector('.sp-nav-icons');
      ...
      // 下スクロール時に .online-shop-icon を画面下に隠す（SPのみ）
      if (onlineShopIcon && window.innerWidth <= 768) {
        if (currentScroll > lastScrollTop && currentScroll > 100) {
    ...
    // Initialize Swiper for SP only
    if (window.innerWidth <= 768) {
      const introSwiper = new Swiper('.intro-swiper', {
        slidesPerView: 2,              // 中央1枚 + 左右0.5ずつ = 2
        spaceBetween: 16,
        centeredSlides: true,          // 中央揃え
        loop: true,                    // 無限ループ
        loopedSlides: 7,              // 実際のスライド数を指定
        initialSlide: 0,              // 1番目のスライドを中央に
        autoplay: {
          delay: 3000,
        ...
        on: {
          init: function() {
            ...
            // 初期化後に確実に1枚目を中央に配置
            setTimeout(() => {
              this.slideToLoop(0, 0); // ループを考慮して1枚目に移動
            }, 100);
          },
          loopFix: function() {
    ...
    <main class="container">
        <section class="intro" id="intro">
            <div class="intro_outer floater bounceIn">
                  ...
                  <div class="intro_inner">
                    ...
                    <div class="box kind">
                        <p class="explain">シンプルからお惣菜系、甘〜いもの、変わり種まで、お子様から、年配の方まで、もぐもぐ美味しく食べられます。</p>
              ...
              <div class="bagel_all_outer">
                <div class="bagel_grid">
                  <img class="bagel_all bagel_main" src="img/intro_one.png" alt="ふわもち新食感のお豆腐ベーグル">
        ...
        <section class="store_info" id="store_info">
            ...
            <div class="store_info_outer">
                ...
                <span class="bold closingday">定休日　水曜日・木曜日</span><br><br>
            ...
            <div class="cafe_items">
                <div class="cafe_item">
                    <div class="cafe_frame">
                        <img src="img/cafe_menu_morning.jpg" alt="モーニングセットのイメージ">
                    </div>
                    <div class="cafe_label">モーニングセット</div>
                </div>
                <div class="cafe_item">
                    <div class="cafe_frame">
                        <img src="img/cafe_menu_lunch.jpg" alt="ランチセットのイメージ">
                    </div>
                    <div class="cafe_label">ランチセット</div>
                </div>
                <div class="cafe_item">
                    <div class="cafe_frame">
        ...
        <section class="other_services" id="other_services">
          ...
          <div class="other_services_inner">
            ...
            <div class="other_services_box">
               ...
               <p class="case_title">ワークショップ</p>
                <p class="text">ハンドメイドや様々なワークショップの開催に</p>
            </div>
            <div class="other_services_box">
                <div class="other_services_frame">
                ...
                <p class="text">誕生日やお祝いパーティー、イベントに対応したオードブルを作成します。</p>
            </div>
            <div class="other_services_box">
                <div class="other_services_frame">
                    <img src="img/other_services_bento.jpg" alt="お弁当のイメージ">
                </div>
                <p class="case_title">お弁当</p>
                <p class="text">X個から、ご要望に応じたお弁当をお作りします。</p>
            </div>
            <div class="other_services_box">
                ...
                <p class="text">人気のチーズケーキをホールで、お祝い事にいかがですか？</p>
            </div>
          </div>
